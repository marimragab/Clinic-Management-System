...
const addPatientValidation = [
  body("fullName")
    ...
    .isLength({ max: 50 })
    .withMessage("Full name can not exceed 50 letters"),
  ...
  body("paymentMethod")
    ...
    .withMessage(
      "paymentMethod should be one of Cash , Credit Card , Insurance Card "
    ),
];
...
const updatePatientValidation = [
  body("id")
    ...
    .notEmpty()
    .withMessage("Id number is required in order to update"),
  ...
  body("age").isInt().withMessage("Age should be a number").optional(),
  ...
  body("address").isObject().withMessage("Enter a valid address").optional(),
  ...
  body("address.building")
    .isInt()
    .withMessage("Building should be a number")
    .optional(),
...
const deletePatientValidation = [
  body("id")
    ...
    .withMessage("Id must be an integer number")
    .notEmpty()
    .withMessage("Id number is required in order to delte"),
];
